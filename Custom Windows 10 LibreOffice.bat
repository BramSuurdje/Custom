...
:REMOVE-BLOATWARE
	IF NOT EXIST "Z:\--Custom--\src\startmenuw10.ps1" (
		COLOR C
		CLS
		ECHO PowerShell-bestanden zijn niet gevonden, zorg ervoor dat deze aanwezig zijn en voer dit script opnieuw uit.
		ECHO Excepted path : "Z:\--Custom--\src\startmenuw10.ps1"
		ECHO Press any key to close this script
		PAUSE > NUL
		EXIT
	)
...
:START_SCRIPT
	...
	powershell -NoProfile -ExecutionPolicy Bypass -File "Z:\--Custom--\src\startmenuw10.ps1"
